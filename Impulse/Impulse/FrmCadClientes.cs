...
namespace Impulse
{
    public partial class FrmCadClientes : Form
    {
        ...
        public void FrmCadClientes_Load(object sender, EventArgs e)
        {
            ...
            this.tccClienteTableAdapter.Fill(this.db_05266_14_A_1_2017DataSet.tccCliente);
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (incluir)
                {
                    tccClienteTableAdapter.InsertQuery(
                        txtNome.Text,
                        txtSetor.Text,
                        txtCpf.Text,
                        txtTel.Text);
                    ...
                    tccClienteTableAdapter.Fill(this.db_05266_14_A_1_2017DataSet.tccCliente);
                }
                if (alterar)
            {
